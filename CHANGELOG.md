...
- Aprovação do design no card de Tela: quando o mock chega, o card mostra "Aprovar design" e "Reprovar". Reprovar pede o que mudar. A conversa de implementação recebe o resultado como mensagem e só coda a tela depois de aprovada. Se o mock for trocado ou editado, o card volta a "aguardando aprovação".
- O agente abre sozinho o painel que o trabalho pede (`nexo_abrir_painel`): o navegador numa URL pra testar uma tela, o Canvas do Design System (focando uma tela) pra criar design, o plano, o Quadro (com uma tarefa aberta), um arquivo ou o terminal. O painel abre na área de trabalho da conversa dele. Em Configurações → Módulos → "Painéis do agente" dá pra escolher: sempre, perguntar antes ou nunca; quais painéis ele pode abrir; e se a aba vem pra frente ou abre atrás da que você está vendo. Navegar pra uma URL continua dependendo do controle de navegador da conta.
