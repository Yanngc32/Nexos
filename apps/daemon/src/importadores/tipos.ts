...
/** Uma conversa já traduzida do formato de origem, pronta pra virar thread do Nexos. */
 ...
 * Nexos...). `reconhece` decide sozinho, olhando só os nomes dos arquivos do zip — sem abrir nada
